...
const AdvancedTariff = () => {
  ...
  return (
    <div className="bg-white xl:px-[36px] xl:pt-[36px] xl:pb-[26px] p-[32px] rounded-28 xl:w-[360px] xl:h-[465px] w-[313px] h-[430px] relative flex justify-between flex-col inset-shadow-custom">
