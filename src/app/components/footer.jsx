    ...
    >
      <div className="h-[488px] flex justify-between overflow-visible relative">
        ...
        <div className="xl:w-[608px] xs:w-[393px] xl:bg-[linear-gradient(124deg,#5bdbfd_0%,#7375ff_40.3%,#df93ff_79.87%,#e56f8c_100%)] xs:bg-[#0c0117]">
          <div className="absolute z-20 left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 xl:w-[447px] xs:w-[280px] flex items-center flex-col">
            ...
            <div className="relative z-20 xl:w-[534px] xs:w-[268px] flex mb-[11px]">
              <BuyButton
                onClick={openModal}
                className="xl:w-[534px] xl:h-[74px] xs:w-[268px] xs:h-[68px] shadow-footer bg-[linear-gradient(121deg,#5bdbfd_0%,#7375ff_40.3%,#df93ff_79.87%,#e56f8c_100%)]
                          ...
                          xl:text-[22px] xs:text-sm text-white rounded-full leading-[1.66667] relative z-30"
              />
              <p className="flex items-center justify-center xl:w-[74px] xl:h-[74px] xs:w-[68px] xs:h-[68px] font-semibold xl:text-2xl xs:text-xl rounded-full text-white leading-[1.53509] bg-[#ff4a77] absolute top-0 right-0 z-40">
                -50%
              </p>
            </div>
          </div>
